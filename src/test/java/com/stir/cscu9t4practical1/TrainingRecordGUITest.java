...
public class TrainingRecordGUITest {
  ...
  public void testAddEntry() {
    ...
    TrainingRecordGUI instance = new TrainingRecordGUI();
    Entry entry = new Entry("Alice", 1, 2, 2003, 0, 16, 7);
   ...
   */
  @Test
  public void testButtonsPresentInGUI()
      throws IllegalAccessException, IllegalArgumentException {
    System.out.println("Check if you have added the buttons");
    TrainingRecordGUI instance = new TrainingRecordGUI();
    Class<?> instanceClass = instance.getClass();
    String[] expectedFields = {
        "findAllByDate", "lookUpByDate"}; // add RemoveEntry when it is ready
    ...
    assertEquals(found, expectedFields.length,
                 "Have you added all required buttons?");
  }
}
